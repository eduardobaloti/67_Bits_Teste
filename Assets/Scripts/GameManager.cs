...
public class GameManager : Singleton<GameManager>
{
    ...
    public void UpLevel()
    {
        if (money == 0)  StartCoroutine(moneyAdviceCor());
        else
        {
    ...
    public void IncreaseMoney(int i)
    {
        ...
        GameManager.Instance.beatedEnemies = 0; 
    }

    public IEnumerator moneyAdviceCor()
    {
        if (moneyAdviceText.activeInHierarchy) yield return null;
        else
        {
